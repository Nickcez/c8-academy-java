...
public class Product {
    ...
    public static long countProducts (List<Product> productsList) {
        ...
        long count = productsList.stream()
                // use the filter method to get a stream of Product objects whose price is less than 30000 using a lambda expression
                .filter(product -> product.price < 30000)
                // use the count method to count the number of Product objects in this stream.
                .count();

        // Store and return the result of this computation into the long count variable
        return count;
    }
